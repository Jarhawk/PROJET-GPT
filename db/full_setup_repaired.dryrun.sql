...
-- [FIX] Add column produits.zone_id
DO $$
BEGIN
  IF NOT EXISTS (
...
-- [FIX] Make policy settings_all idempotent
ALTER TABLE public.settings ENABLE ROW LEVEL SECURITY;
DO $$
BEGIN
  IF NOT EXISTS (
    ...
    CREATE POLICY settings_all ON public.settings
      for all using (mama_id = current_user_mama_id()) with check (mama_id = current_user_mama_id());
  END IF;
END $$;

-- [FIX] Make policy user_mama_access_select idempotent
ALTER TABLE public.user_mama_access ENABLE ROW LEVEL SECURITY;
DO $$
BEGIN
  IF NOT EXISTS (
...
-- [FIX] Make policy user_mama_access_modify idempotent
ALTER TABLE public.user_mama_access ENABLE ROW LEVEL SECURITY;
DO $$
BEGIN
  IF NOT EXISTS (
...
-- [FIX] Make policy ventes_fiches_all idempotent
ALTER TABLE public.ventes_fiches ENABLE ROW LEVEL SECURITY;
DO $$
BEGIN
  IF NOT EXISTS (
...
-- [FIX] Make policy ventes_import_staging_all idempotent
ALTER TABLE public.ventes_import_staging ENABLE ROW LEVEL SECURITY;
DO $$
BEGIN
  IF NOT EXISTS (
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='requisitions' and policyname='requisitions_select'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='requisitions' and policyname='requisitions_insert'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='requisitions' and policyname='requisitions_update'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='requisitions' and policyname='requisitions_delete'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='requisition_lignes' and policyname='requisition_lignes_select'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='requisition_lignes' and policyname='requisition_lignes_insert'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='requisition_lignes' and policyname='requisition_lignes_update'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='requisition_lignes' and policyname='requisition_lignes_delete'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='produits_zones' and policyname='pz_select'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='produits_zones' and policyname='pz_iud'
  ) then
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE c.contype='f' AND c.conname='fk_fournisseurs_mama_id'
      AND n.nspname='public' AND cl.relname='fournisseurs'
  ) THEN
    ALTER TABLE public.fournisseurs
      ADD CONSTRAINT fk_fournisseurs_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_roles_mama_id'
      AND n.nspname='public' AND cl.relname='roles'
  ) THEN
    ALTER TABLE public.roles
      ADD CONSTRAINT fk_roles_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_utilisateurs_mama_id'
      AND n.nspname='public' AND cl.relname='utilisateurs'
  ) THEN
    ALTER TABLE public.utilisateurs
      ADD CONSTRAINT fk_utilisateurs_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_utilisateurs_role_id'
      AND n.nspname='public' AND cl.relname='utilisateurs'
  ) THEN
    ALTER TABLE public.utilisateurs
      ADD CONSTRAINT fk_utilisateurs_role_id
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_commandes_mama_id'
      AND n.nspname='public' AND cl.relname='commandes'
  ) THEN
    ALTER TABLE public.commandes
      ADD CONSTRAINT fk_commandes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_commandes_fournisseur_id'
      AND n.nspname='public' AND cl.relname='commandes'
  ) THEN
    ALTER TABLE public.commandes
      ADD CONSTRAINT fk_commandes_fournisseur_id
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_commandes_created_by'
      AND n.nspname='public' AND cl.relname='commandes'
  ) THEN
    ALTER TABLE public.commandes
      ADD CONSTRAINT fk_commandes_created_by
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_commandes_validated_by'
      AND n.nspname='public' AND cl.relname='commandes'
  ) THEN
    ALTER TABLE public.commandes
      ADD CONSTRAINT fk_commandes_validated_by
      FOREIGN KEY (validated_by) REFERENCES public.utilisateurs(id) on delete set null;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_commande_lignes_commande_id'
      AND n.nspname='public' AND cl.relname='commande_lignes'
  ) THEN
    ALTER TABLE public.commande_lignes
      ADD CONSTRAINT fk_commande_lignes_commande_id
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_commande_lignes_produit_id'
      AND n.nspname='public' AND cl.relname='commande_lignes'
  ) THEN
    ALTER TABLE public.commande_lignes
      ADD CONSTRAINT fk_commande_lignes_produit_id
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_commande_lignes_mama_id'
      AND n.nspname='public' AND cl.relname='commande_lignes'
  ) THEN
    ALTER TABLE public.commande_lignes
      ADD CONSTRAINT fk_commande_lignes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_templates_commandes_mama_id'
      AND n.nspname='public' AND cl.relname='templates_commandes'
  ) THEN
    ALTER TABLE public.templates_commandes
      ADD CONSTRAINT fk_templates_commandes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_templates_commandes_fournisseur_id'
      AND n.nspname='public' AND cl.relname='templates_commandes'
  ) THEN
    ALTER TABLE public.templates_commandes
      ADD CONSTRAINT fk_templates_commandes_fournisseur_id
      FOREIGN KEY (fournisseur_id) REFERENCES public.fournisseurs(id) on delete set null;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_emails_envoyes_commande_id'
      AND n.nspname='public' AND cl.relname='emails_envoyes'
  ) THEN
    ALTER TABLE public.emails_envoyes
      ADD CONSTRAINT fk_emails_envoyes_commande_id
      FOREIGN KEY (commande_id) REFERENCES public.commandes(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_emails_envoyes_mama_id'
      AND n.nspname='public' AND cl.relname='emails_envoyes'
  ) THEN
    ALTER TABLE public.emails_envoyes
      ADD CONSTRAINT fk_emails_envoyes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_permissions_role_id'
      AND n.nspname='public' AND cl.relname='permissions'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_permissions_mama_id'
      AND n.nspname='public' AND cl.relname='permissions'
  ) THEN
    ALTER TABLE public.permissions
      ADD CONSTRAINT fk_permissions_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_consentements_utilisateur_utilisateur_id'
      AND n.nspname='public' AND cl.relname='consentements_utilisateur'
  ) THEN
    ALTER TABLE public.consentements_utilisateur
      ADD CONSTRAINT fk_consentements_utilisateur_utilisateur_id
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_consentements_utilisateur_mama_id'
      AND n.nspname='public' AND cl.relname='consentements_utilisateur'
  ) THEN
    ALTER TABLE public.consentements_utilisateur
      ADD CONSTRAINT fk_consentements_utilisateur_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_achats_mama_id'
      AND n.nspname='public' AND cl.relname='achats'
  ) THEN
    ALTER TABLE public.achats
      ADD CONSTRAINT fk_achats_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_achats_produit_id'
      AND n.nspname='public' AND cl.relname='achats'
  ) THEN
    ALTER TABLE public.achats
      ADD CONSTRAINT fk_achats_produit_id
      FOREIGN KEY (produit_id) REFERENCES public.produits(id) on delete restrict;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_achats_fournisseur_id'
      AND n.nspname='public' AND cl.relname='achats'
  ) THEN
    ALTER TABLE public.achats
      ADD CONSTRAINT fk_achats_fournisseur_id
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_alertes_mama_id'
      AND n.nspname='public' AND cl.relname='alertes'
  ) THEN
    ALTER TABLE public.alertes
      ADD CONSTRAINT fk_alertes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_api_keys_mama_id'
      AND n.nspname='public' AND cl.relname='api_keys'
  ) THEN
    ALTER TABLE public.api_keys
      ADD CONSTRAINT fk_api_keys_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_auth_double_facteur_mama_id'
      AND n.nspname='public' AND cl.relname='auth_double_facteur'
  ) THEN
    ALTER TABLE public.auth_double_facteur
      ADD CONSTRAINT fk_auth_double_facteur_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_bons_livraison_mama_id'
      AND n.nspname='public' AND cl.relname='bons_livraison'
  ) THEN
    ALTER TABLE public.bons_livraison
      ADD CONSTRAINT fk_bons_livraison_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_catalogue_updates_mama_id'
      AND n.nspname='public' AND cl.relname='catalogue_updates'
  ) THEN
    ALTER TABLE public.catalogue_updates
      ADD CONSTRAINT fk_catalogue_updates_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_centres_de_cout_mama_id'
      AND n.nspname='public' AND cl.relname='centres_de_cout'
  ) THEN
    ALTER TABLE public.centres_de_cout
      ADD CONSTRAINT fk_centres_de_cout_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_compta_mapping_mama_id'
      AND n.nspname='public' AND cl.relname='compta_mapping'
  ) THEN
    ALTER TABLE public.compta_mapping
      ADD CONSTRAINT fk_compta_mapping_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_documentation_mama_id'
      AND n.nspname='public' AND cl.relname='documentation'
  ) THEN
    ALTER TABLE public.documentation
      ADD CONSTRAINT fk_documentation_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_documents_mama_id'
      AND n.nspname='public' AND cl.relname='documents'
  ) THEN
    ALTER TABLE public.documents
      ADD CONSTRAINT fk_documents_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_etapes_onboarding_mama_id'
      AND n.nspname='public' AND cl.relname='etapes_onboarding'
  ) THEN
    ALTER TABLE public.etapes_onboarding
      ADD CONSTRAINT fk_etapes_onboarding_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_facture_lignes_mama_id'
      AND n.nspname='public' AND cl.relname='facture_lignes'
  ) THEN
    ALTER TABLE public.facture_lignes
      ADD CONSTRAINT fk_facture_lignes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_factures_mama_id'
      AND n.nspname='public' AND cl.relname='factures'
  ) THEN
    ALTER TABLE public.factures
      ADD CONSTRAINT fk_factures_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_familles_mama_id'
      AND n.nspname='public' AND cl.relname='familles'
  ) THEN
    ALTER TABLE public.familles
      ADD CONSTRAINT fk_familles_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_feedback_mama_id'
      AND n.nspname='public' AND cl.relname='feedback'
  ) THEN
    ALTER TABLE public.feedback
      ADD CONSTRAINT fk_feedback_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fiche_cout_history_mama_id'
      AND n.nspname='public' AND cl.relname='fiche_cout_history'
  ) THEN
    ALTER TABLE public.fiche_cout_history
      ADD CONSTRAINT fk_fiche_cout_history_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fiche_lignes_mama_id'
      AND n.nspname='public' AND cl.relname='fiche_lignes'
  ) THEN
    ALTER TABLE public.fiche_lignes
      ADD CONSTRAINT fk_fiche_lignes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fiches_mama_id'
      AND n.nspname='public' AND cl.relname='fiches'
  ) THEN
    ALTER TABLE public.fiches
      ADD CONSTRAINT fk_fiches_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fiches_techniques_mama_id'
      AND n.nspname='public' AND cl.relname='fiches_techniques'
  ) THEN
    ALTER TABLE public.fiches_techniques
      ADD CONSTRAINT fk_fiches_techniques_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fournisseur_contacts_mama_id'
      AND n.nspname='public' AND cl.relname='fournisseur_contacts'
  ) THEN
    ALTER TABLE public.fournisseur_contacts
      ADD CONSTRAINT fk_fournisseur_contacts_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fournisseur_notes_mama_id'
      AND n.nspname='public' AND cl.relname='fournisseur_notes'
  ) THEN
    ALTER TABLE public.fournisseur_notes
      ADD CONSTRAINT fk_fournisseur_notes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fournisseur_produits_mama_id'
      AND n.nspname='public' AND cl.relname='fournisseur_produits'
  ) THEN
    ALTER TABLE public.fournisseur_produits
      ADD CONSTRAINT fk_fournisseur_produits_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fournisseur_produits_produit_id'
      AND n.nspname='public' AND cl.relname='fournisseur_produits'
  ) THEN
    ALTER TABLE public.fournisseur_produits
      ADD CONSTRAINT fk_fournisseur_produits_produit_id
      FOREIGN KEY (produit_id) REFERENCES public.produits(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fournisseur_produits_fournisseur_id'
      AND n.nspname='public' AND cl.relname='fournisseur_produits'
  ) THEN
    ALTER TABLE public.fournisseur_produits
      ADD CONSTRAINT fk_fournisseur_produits_fournisseur_id
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_fournisseurs_api_config_mama_id'
      AND n.nspname='public' AND cl.relname='fournisseurs_api_config'
  ) THEN
    ALTER TABLE public.fournisseurs_api_config
      ADD CONSTRAINT fk_fournisseurs_api_config_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_gadgets_mama_id'
      AND n.nspname='public' AND cl.relname='gadgets'
  ) THEN
    ALTER TABLE public.gadgets
      ADD CONSTRAINT fk_gadgets_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_groupes_mama_id'
      AND n.nspname='public' AND cl.relname='groupes'
  ) THEN
    ALTER TABLE public.groupes
      ADD CONSTRAINT fk_groupes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_guides_seen_mama_id'
      AND n.nspname='public' AND cl.relname='guides_seen'
  ) THEN
    ALTER TABLE public.guides_seen
      ADD CONSTRAINT fk_guides_seen_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_help_articles_mama_id'
      AND n.nspname='public' AND cl.relname='help_articles'
  ) THEN
    ALTER TABLE public.help_articles
      ADD CONSTRAINT fk_help_articles_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_inventaire_zones_mama_id'
      AND n.nspname='public' AND cl.relname='inventaire_zones'
  ) THEN
    ALTER TABLE public.inventaire_zones
      ADD CONSTRAINT fk_inventaire_zones_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_journaux_utilisateur_mama_id'
      AND n.nspname='public' AND cl.relname='journaux_utilisateur'
  ) THEN
    ALTER TABLE public.journaux_utilisateur
      ADD CONSTRAINT fk_journaux_utilisateur_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_lignes_bl_mama_id'
      AND n.nspname='public' AND cl.relname='lignes_bl'
  ) THEN
    ALTER TABLE public.lignes_bl
      ADD CONSTRAINT fk_lignes_bl_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_logs_securite_mama_id'
      AND n.nspname='public' AND cl.relname='logs_securite'
  ) THEN
    ALTER TABLE public.logs_securite
      ADD CONSTRAINT fk_logs_securite_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_menu_fiches_mama_id'
      AND n.nspname='public' AND cl.relname='menu_fiches'
  ) THEN
    ALTER TABLE public.menu_fiches
      ADD CONSTRAINT fk_menu_fiches_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_menus_mama_id'
      AND n.nspname='public' AND cl.relname='menus'
  ) THEN
    ALTER TABLE public.menus
      ADD CONSTRAINT fk_menus_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_menus_jour_mama_id'
      AND n.nspname='public' AND cl.relname='menus_jour'
  ) THEN
    ALTER TABLE public.menus_jour
      ADD CONSTRAINT fk_menus_jour_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_menus_jour_fiches_mama_id'
      AND n.nspname='public' AND cl.relname='menus_jour_fiches'
  ) THEN
    ALTER TABLE public.menus_jour_fiches
      ADD CONSTRAINT fk_menus_jour_fiches_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_notification_preferences_mama_id'
      AND n.nspname='public' AND cl.relname='notification_preferences'
  ) THEN
    ALTER TABLE public.notification_preferences
      ADD CONSTRAINT fk_notification_preferences_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_notifications_mama_id'
      AND n.nspname='public' AND cl.relname='notifications'
  ) THEN
    ALTER TABLE public.notifications
      ADD CONSTRAINT fk_notifications_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_parametres_commandes_mama_id'
      AND n.nspname='public' AND cl.relname='parametres_commandes'
  ) THEN
    ALTER TABLE public.parametres_commandes
      ADD CONSTRAINT fk_parametres_commandes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_pertes_mama_id'
      AND n.nspname='public' AND cl.relname='pertes'
  ) THEN
    ALTER TABLE public.pertes
      ADD CONSTRAINT fk_pertes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_planning_lignes_mama_id'
      AND n.nspname='public' AND cl.relname='planning_lignes'
  ) THEN
    ALTER TABLE public.planning_lignes
      ADD CONSTRAINT fk_planning_lignes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_planning_previsionnel_mama_id'
      AND n.nspname='public' AND cl.relname='planning_previsionnel'
  ) THEN
    ALTER TABLE public.planning_previsionnel
      ADD CONSTRAINT fk_planning_previsionnel_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_promotions_mama_id'
      AND n.nspname='public' AND cl.relname='promotions'
  ) THEN
    ALTER TABLE public.promotions
      ADD CONSTRAINT fk_promotions_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_regles_alertes_mama_id'
      AND n.nspname='public' AND cl.relname='regles_alertes'
  ) THEN
    ALTER TABLE public.regles_alertes
      ADD CONSTRAINT fk_regles_alertes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_produits_zone_id'
      AND n.nspname='public' AND cl.relname='produits'
  ) THEN
    ALTER TABLE public.produits
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_signalements_mama_id'
      AND n.nspname='public' AND cl.relname='signalements'
  ) THEN
    ALTER TABLE public.signalements
      ADD CONSTRAINT fk_signalements_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_sous_familles_mama_id'
      AND n.nspname='public' AND cl.relname='sous_familles'
  ) THEN
    ALTER TABLE public.sous_familles
      ADD CONSTRAINT fk_sous_familles_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_sous_familles_famille_id'
      AND n.nspname='public' AND cl.relname='sous_familles'
  ) THEN
    ALTER TABLE public.sous_familles
      ADD CONSTRAINT fk_sous_familles_famille_id
      FOREIGN KEY (famille_id) REFERENCES public.familles(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_stocks_mama_id'
      AND n.nspname='public' AND cl.relname='stocks'
  ) THEN
    ALTER TABLE public.stocks
      ADD CONSTRAINT fk_stocks_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_tableaux_de_bord_mama_id'
      AND n.nspname='public' AND cl.relname='tableaux_de_bord'
  ) THEN
    ALTER TABLE public.tableaux_de_bord
      ADD CONSTRAINT fk_tableaux_de_bord_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_taches_mama_id'
      AND n.nspname='public' AND cl.relname='taches'
  ) THEN
    ALTER TABLE public.taches
      ADD CONSTRAINT fk_taches_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_tooltips_mama_id'
      AND n.nspname='public' AND cl.relname='tooltips'
  ) THEN
    ALTER TABLE public.tooltips
      ADD CONSTRAINT fk_tooltips_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_transfert_lignes_mama_id'
      AND n.nspname='public' AND cl.relname='transfert_lignes'
  ) THEN
    ALTER TABLE public.transfert_lignes
      ADD CONSTRAINT fk_transfert_lignes_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_transferts_mama_id'
      AND n.nspname='public' AND cl.relname='transferts'
  ) THEN
    ALTER TABLE public.transferts
      ADD CONSTRAINT fk_transferts_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_unites_mama_id'
      AND n.nspname='public' AND cl.relname='unites'
  ) THEN
    ALTER TABLE public.unites
      ADD CONSTRAINT fk_unites_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_produits_mama_id'
      AND n.nspname='public' AND cl.relname='produits'
  ) THEN
    ALTER TABLE public.produits
      ADD CONSTRAINT fk_produits_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_produits_fournisseur_id'
      AND n.nspname='public' AND cl.relname='produits'
  ) THEN
    ALTER TABLE public.produits
      ADD CONSTRAINT fk_produits_fournisseur_id
      FOREIGN KEY (fournisseur_id) REFERENCES public.fournisseurs(id) on delete set null;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_produits_unite_id'
      AND n.nspname='public' AND cl.relname='produits'
  ) THEN
    ALTER TABLE public.produits
      ADD CONSTRAINT fk_produits_unite_id
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_produits_famille_id'
      AND n.nspname='public' AND cl.relname='produits'
  ) THEN
    ALTER TABLE public.produits
      ADD CONSTRAINT fk_produits_famille_id
      FOREIGN KEY (famille_id) REFERENCES public.familles(id) on delete set null;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_produits_sous_famille_id'
      AND n.nspname='public' AND cl.relname='produits'
  ) THEN
    ALTER TABLE public.produits
      ADD CONSTRAINT fk_produits_sous_famille_id
      FOREIGN KEY (sous_famille_id) REFERENCES public.sous_familles(id) on delete set null;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_usage_stats_mama_id'
      AND n.nspname='public' AND cl.relname='usage_stats'
  ) THEN
    ALTER TABLE public.usage_stats
      ADD CONSTRAINT fk_usage_stats_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_utilisateurs_taches_mama_id'
      AND n.nspname='public' AND cl.relname='utilisateurs_taches'
  ) THEN
    ALTER TABLE public.utilisateurs_taches
      ADD CONSTRAINT fk_utilisateurs_taches_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_validation_requests_mama_id'
      AND n.nspname='public' AND cl.relname='validation_requests'
  ) THEN
    ALTER TABLE public.validation_requests
      ADD CONSTRAINT fk_validation_requests_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_ventes_boissons_mama_id'
      AND n.nspname='public' AND cl.relname='ventes_boissons'
  ) THEN
    ALTER TABLE public.ventes_boissons
      ADD CONSTRAINT fk_ventes_boissons_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class cl ON cl.oid = c.conrelid
    JOIN pg_namespace n ON n.oid = cl.relnamespace
    WHERE c.contype='f' AND c.conname='fk_ventes_fiches_carte_mama_id'
      AND n.nspname='public' AND cl.relname='ventes_fiches_carte'
  ) THEN
    ALTER TABLE public.ventes_fiches_carte
      ADD CONSTRAINT fk_ventes_fiches_carte_mama_id
      FOREIGN KEY (mama_id) REFERENCES public.mamas(id) on delete cascade;
  END IF;
END $$;
